...
{
  "action": [
    { "patient_id": "p1", "type": "assign_doctor", "doctor_tier": "t2" },
...
Each action targets a specific patient by `patient_id`:

| Action Type      | Required Extra Field | Description                          |
| :--------------- | :------------------- | :----------------------------------- |
| `no_op`          | —                    | Do nothing for this patient this tick |
| `assign_doctor`  | `doctor_tier: t1/t2/t3` | Assign a doctor to begin treatment |
